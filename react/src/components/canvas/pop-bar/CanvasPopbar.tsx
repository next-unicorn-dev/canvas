...
const CanvasPopbar = ({ selectedImages, onInstagramClick }: CanvasPopbarProps) => {
  ...
  return (
    <>
      ...
      <Button variant="ghost" size="sm" onClick={handleUploadToInstagram}>
        <Instagram className="w-4 h-4 mr-1" />
        {t('canvas:popbar.uploadToInstagram')}
      </Button>
    </>
  )
}
