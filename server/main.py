...
from routers import auth_router, config_router, image_router, root_router, workspace, canvas, ssl_test, chat_router, settings, tool_confirmation, instagram_router, admin_router
...
app = FastAPI(
    title="Prism AI API",
    description="Prism AI Backend API Documentation",
    version="1.0.0",
    lifespan=lifespan,
    docs_url="/docs",
    redoc_url="/redoc",
