...
from services.migrations.v5_add_instagram import V5AddInstagram
from services.migrations.v6_add_brand_info import V6AddBrandInfo
...
ALL_MIGRATIONS = [
    ...
    {
        'version': 5,
        'migration': V5AddInstagram,
    },
    {
        'version': 6,
        'migration': V6AddBrandInfo,
    },
    {
        'version': 7,
