...
class PlannerAgentConfig(BaseAgentConfig):
    ...
    def __init__(self) -> None:
        system_prompt = """
            ...
            - Step 3. If the user wants to upload an image to Instagram, include a step for 'Upload to Instagram' in the plan and transfer to `image_video_creator` agent.
            ...
            4. If the user wants to upload to Instagram, ALWAYS include this in the plan and handoff to image_video_creator. Do not say you cannot do it.
