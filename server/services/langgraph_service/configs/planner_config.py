...
class PlannerAgentConfig(BaseAgentConfig):
    ...
    def __init__(self) -> None:
        system_prompt = """
            ...
            - Step 2. If it is a image/video generation, editing, or Instagram upload task, transfer the task to image_video_creator agent IMMEDIATELY, no need to ask for user's approval.
            ...
            4. When user asks to upload to Instagram (e.g. "인스타그램에 올려줘", "upload to Instagram", "post to Instagram"), transfer to image_video_creator agent who has the upload_to_instagram tool.
        ...
        handoffs: List[HandoffConfig] = [
            {
                ...
                'description': """
                        Transfer user to the image_video_creator. About this agent: Specialize in generating images, videos, AND uploading images to Instagram. Transfer here when user asks for image generation, video generation, or Instagram upload.
                        """
            }
        ]
