...
from tools.upload_to_instagram import upload_to_instagram
...
from tools.generate_image_by_nanobanana_google import (
    generate_image_by_nanobanana_google,
)
from tools.generate_image_by_nanobanana_pro_google import (
    generate_image_by_nanobanana_pro_google,
)
from tools.generate_image_by_dalle_3_openai import (
    generate_image_by_dalle_3_openai,
)
from tools.generate_video_by_veo3_google import (
    generate_video_by_veo3_google,
)
...
TOOL_MAPPING: Dict[str, ToolInfo] = {
    ...
    "generate_image_by_nanobanana_google": {
        ...
        "type": "image",
        "provider": "google",
        "tool_function": generate_image_by_nanobanana_google,
    },
    "generate_image_by_nanobanana_pro_google": {
        "display_name": "Nanobanana Pro",
        "type": "image",
        "provider": "google",
        "tool_function": generate_image_by_nanobanana_pro_google,
    },
    "generate_image_by_dalle_3_openai": {
        "display_name": "DALL-E 3",
        "type": "image",
        "provider": "openai",
        "tool_function": generate_image_by_dalle_3_openai,
    },
    # ---------------
    # Google Tools
    # ---------------
    "generate_video_by_veo3_google": {
        ...
        "type": "video",
        "provider": "google",
        "tool_function": generate_video_by_veo3_google,
    },
}
...
class ToolService:
    ...
    def _register_required_tools(self):
        ...
        try:
            ...
            self.tools["upload_to_instagram"] = {
                "provider": "system",
                "tool_function": upload_to_instagram,
            }
