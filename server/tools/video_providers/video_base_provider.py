...
def get_default_provider(model_info_list: Optional[List[ModelInfo]] = None) -> str:
    ...
    Args:
        model_info_list: List of model info dictionaries. If provided, the first
            provider entry with a valid name will be used.
    ...
    # Default fallback to volces provider which is bundled with the app
    return "volces"
